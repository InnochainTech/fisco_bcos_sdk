...
public class OkHttpUtils {
    ...
    private Map<String, Object> postParamMap;
    private String url;
     ...
     * @return
     */
    public OkHttpUtils addPostParam(String key, Object value) {
        if (postParamMap == null) {
            postParamMap = new LinkedHashMap<>(16);
        }
     ...
     * 初始化post方法
     *
     * @param isJsonPost true等于json的方式提交数据，类似postman里post方法的raw addPostparam（）
     *                   false等于普通的表单提交 使用addparam（） paramMap传数据
     * @return
     */
    public OkHttpUtils post(boolean isJsonPost) {
        ...
        if (isJsonPost) {
            String json = "";
            if (postParamMap != null) {
                json = JSON.toJSONString(postParamMap);
            }
