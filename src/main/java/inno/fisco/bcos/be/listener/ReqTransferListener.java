 ...
 */
@Component
public class ReqTransferListener implements MessageListenerConcurrently {
    private static final Logger LOGGER = LoggerFactory.getLogger(ReqTransferListener.class);
