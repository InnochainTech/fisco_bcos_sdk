...
public class TransactionMaker
{
     ...
     * @return 编码后的交易内容
     */
    public String encodeConstructor(ABICodec abiCodec, String abiContent, String binContent, List<Object> params) throws ABICodecException {
     ...
     * @param params 调用合约的参数列表
     * @return 编码后的交易内容
     */
    public String encodeMethod(ABICodec abiCodec, String abiContent, String methodName, List<Object> params) throws ABICodecException {
